...
function FactoryRegisterBehaviour:Unregister()
	...
	game:SendToConsole(mtype, network, self.ai.factoryBuilded[mtype], self.ai.factoryBuilded[mtype][network], self.name, unitTable[self.name], unitTable[self.name].techLevel)
